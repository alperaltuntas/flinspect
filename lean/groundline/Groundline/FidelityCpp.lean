...
`Groundline/GeneratedCpp.lean` is emitted by the deterministic printer
...
were written by hand from the C++ source when the first kernels were banked. These theorems
...
hand-written reference `ppmLimitPosC`. -/
theorem generated_cpp_ppm_limit_pos_fidelity :
    Groundline.GeneratedCpp.ppm_limit_pos_point = Groundline.ppmLimitPosC := rfl
...
theorem generated_cpp_ppm_limit_cw84_fidelity (h_L h_R h_in : ℝ) :
    Groundline.GeneratedCpp.ppm_limit_cw84_point h_L h_R h_in
      = Groundline.ppmLimitCw84C h_L h_R h_in := by
  simp only [Groundline.GeneratedCpp.ppm_limit_cw84_point, Groundline.ppmLimitCw84C]
  split_ifs <;> rfl
...
theorem generated_cpp_matches_generated_fortran_pos (h_in h_L h_R h_min : ℝ) :
    Groundline.GeneratedCpp.ppm_limit_pos_point h_L h_R h_in h_min
...
theorem generated_cpp_matches_generated_fortran_cw84 (h_in h_L h_R : ℝ) :
    Groundline.GeneratedCpp.ppm_limit_cw84_point h_L h_R h_in
      = Groundline.GeneratedFtn.ppm_limit_cw84 h_in h_L h_R := by
  rw [generated_cpp_ppm_limit_cw84_fidelity]
  exact Groundline.ppmLimitCw84_point_equiv h_L h_R h_in
